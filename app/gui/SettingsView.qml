    ...
    Column {
        ...
        GroupBox {
            ...
            Column {
                ...
                CheckBox {
                    id: parallelMicPassthroughCheck
                    width: parent.width
                    text: qsTr("Send microphone to host via parallel UDP channel (port 9000)")
                    font.pointSize: 12
                    checked: StreamingPreferences.parallelMicrophonePassthrough
                    onCheckedChanged: {
                        StreamingPreferences.parallelMicrophonePassthrough = checked
                    }

                    ToolTip.delay: 1000
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Captures your default microphone and sends PCM audio to the host over a separate UDP connection. Does not use the native Moonlight audio stream.")
                }
            }
        }
