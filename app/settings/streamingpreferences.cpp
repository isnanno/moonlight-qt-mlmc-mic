...
#define SER_PARALLEL_MIC_PASSTHROUGH "parallelmicpassthrough"
...
void StreamingPreferences::reload()
{
    ...
    parallelMicrophonePassthrough = settings.value(SER_PARALLEL_MIC_PASSTHROUGH, false).toBool();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_PARALLEL_MIC_PASSTHROUGH, parallelMicrophonePassthrough);
