...
public:
    ...
    Q_PROPERTY(bool autoReconnectOnError MEMBER autoReconnectOnError NOTIFY autoReconnectOnErrorChanged)
    ...
    Q_PROPERTY(bool parallelMicrophonePassthrough MEMBER parallelMicrophonePassthrough NOTIFY parallelMicrophonePassthroughChanged)
    ...
    bool parallelMicrophonePassthrough;
...
signals:
    ...
    void autoReconnectOnErrorChanged();
    ...
    void parallelMicrophonePassthroughChanged();
